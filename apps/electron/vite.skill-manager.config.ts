...
export default defineConfig({
  ...
  base: './',
  build: {
    outDir: resolve(__dirname, 'dist/skill-manager'),
    emptyDirBeforeWrite: true,
    sourcemap: true,
    rollupOptions: {
      input: {
        'skill-manager': resolve(__dirname, 'src/renderer/skill-manager.html'),
      },
    },
  },
  resolve: {
    alias: {
      ...
      'croner': resolve(__dirname, 'src/renderer/shims/croner.ts'),
      'electron-log/main': resolve(__dirname, 'src/renderer/shims/electron-log-main.ts'),
